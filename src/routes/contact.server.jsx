    ...
    <Layout hero={<GradientBackground />}>
      <div className="">
        <Suspense fallback={<BoxFallback />}>
          <section className="overflow-hidden relative z-10 flex justify-center w-full mt-10">
            <div className="">
              <div className="">
                <div className="">
                  <div className="lg:mb-0 rounded-xl border-4 border-[#84754E] bg-white">
                    <span className="mb-4 text-base font-semibold text-rylesblue flex justify-center">
                      Contact Us
                    </span>
                    <h2
                      className="
                  ...
                  "
                    ...
                    <p className="text-lg font-bold text-body-color leading-relaxed mb-9 text-rylesblue flex justify-center pl-4 pr-4">
                      We at Ryles Pharmacy are here to answer any questions you
                      may have
                    </p>
                    <p className="text-lg font-bold text-body-color leading-relaxed mb-9 text-rylesblue flex justify-center pl-4 pr-4">
                    ...
                    <p className="text-lg font-bold text-body-color leading-relaxed mb-9 text-rylesblue flex justify-center pl-4 pr-4">
                      Please note we can not deal with prescriptions online so
                      call in store to us for any of your prescription needs
                    </p>
                    <div className="flex w-full justify-center">
                      <div className="flex mb-8 max-w-[370px] w-full justify-center">
                        <div
                          className="
                     max-w-[60px]
                     sm:max-w-[70px]
                     ...
                     "
                        ...
                        <div className="w-full">
                          <h4 className="font-bold text-dark text-xl mb-1 text-rylesblue">
                            Our Location
                          </h4>
                          <p className="text-base text-body-color text-rylesblue">
