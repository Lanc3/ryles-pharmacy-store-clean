    ...
    <div className="flex justify-center h-14 mb-10">
      {pending ? (
        ...
        <button
          type="button"
          disabled={pending}
          className={`uppercase border-4 bg-white border-ryles-blue text-black text-center px-5 py-3 font-mono font-bold drop-shadow-lg active:drop-shadow-none hover:bg-ryles-blue rounded-md hover:text-white hover:border-white ${
